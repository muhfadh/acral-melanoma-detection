...
dir1 = ['static/image/70-30/training/acral melanoma/',
        'static/image/70-30/testing/acral melanoma/',
        'static/image/70-30/training/benign nevi/',
        'static/image/70-30/testing/benign nevi/']
...
class FeatureExtractor:
    def __init__(self):
        ...
        self.model3 = Model(inputs=inputs, outputs=drop_out1)
